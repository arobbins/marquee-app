...
var app=angular.module("app",["ui.bootstrap","ui.router","xeditable"]);app.config(function($stateProvider,$urlRouterProvider){$urlRouterProvider.otherwise("/"),$stateProvider.state("home",{url:"/",templateUrl:"../views/feature.html"}).state("marquees",{url:"/marquees",templateUrl:"../views/marquees/marquees.html"})}),app.directive("release",function(){return{restrict:"A",scope:{marquee:"="},templateUrl:"../views/directive1.html",controller:function($scope){console.log($scope.marquee)}}}),app.controller("MarqueeCtrl",function($scope){var releaseDates=["March 2014","February 2014","January 2014","December 2013"],marquees=[{contentkey:"aaa612",template:"tpl-left",header:"Headline",body:"Body",button:"Button",image:"../imgs/marquee.jpeg",toggled:!1,release:releaseDates[0]},{contentkey:"pfw0314",template:"tpl-left",header:"Headline",body:"Body",button:"Button",image:"../imgs/marquee.jpeg",toggled:!1,release:releaseDates[1]},{contentkey:"wyndham0314",template:"tpl-left",header:"Headline",body:"Body",button:"Button",image:"../imgs/marquee.jpeg",toggled:!1,release:releaseDates[1]},{contentkey:"vinesse1013",template:"tpl-left",header:"Headline",body:"Body",button:"Button",image:"../imgs/marquee.jpeg",toggled:!1,release:releaseDates[2]},{contentkey:"ssolinkaccounts1211",template:"tpl-left",header:"Headline",body:"Body",button:"Button",image:"../imgs/marquee.jpeg",toggled:!1,release:releaseDates[2]},{contentkey:"select0213",template:"tpl-left",header:"Headline",body:"Body",button:"Button",image:"../imgs/marquee.jpeg",toggled:!1,release:releaseDates[2]},{contentkey:"acelareactfall2012",template:"tpl-left",header:"Headline",body:"Body",button:"Button",image:"../imgs/marquee.jpeg",toggled:!1,release:releaseDates[3]},{contentkey:"amtrakbookingfall2012",template:"tpl-left",header:"Headline",body:"Body",button:"Button",image:"../imgs/marquee.jpeg",toggled:!1,release:releaseDates[0]},{contentkey:"amtrakbrand0713",template:"tpl-left",header:"Headline",body:"Body",button:"Button",image:"../imgs/marquee.jpeg",toggled:!1,release:releaseDates[3]},{contentkey:"facebook1112",template:"tpl-left",header:"Headline",body:"Body",button:"Button",image:"../imgs/marquee.jpeg",toggled:!1,release:releaseDates[1]},{contentkey:"hyatt0913",template:"tpl-left",header:"Headline",body:"Body",button:"Button",image:"../imgs/marquee.jpeg",toggled:!1,release:releaseDates[2]},{contentkey:"metlife0913",template:"tpl-left",header:"Headline",body:"Body",button:"Button",image:"../imgs/marquee.jpeg",toggled:!1,release:releaseDates[3]},{contentkey:"partneroi1113",template:"tpl-left",header:"Headline",body:"Body",button:"Button",image:"../imgs/marquee.jpeg",toggled:!1,release:releaseDates[0]},{contentkey:"energyplus1213",template:"tpl-left",header:"Headline",body:"Body",button:"Button",image:"../imgs/marquee.jpeg",toggled:!1,release:releaseDates[2]},{contentkey:"budgetJan2014",template:"tpl-left",header:"Headline",body:"Body",button:"Button",image:"../imgs/marquee.jpeg",toggled:!1,release:releaseDates[0]},{contentkey:"pfw1013",template:"tpl-left",header:"Headline",body:"Body",button:"Button",image:"../imgs/marquee.jpeg",toggled:!1,release:releaseDates[3]}];$scope.marquees=marquees,$scope.releaseDates=releaseDates,$scope.addMarquee=function(){for(var count=0,i=0;i<=$scope.marquees.length;i++)count++;$scope.marquees.unshift({contentkey:"contentkey",title:"Marquee #"+count++,template:"tpl-left",header:"Headline",body:"Body",button:"Button",toggled:!1,image:"../imgs/marquee.jpeg"})},$scope.removeMarquee=function(){$scope.marquees.splice(0,1)},$scope.sortMarqueeByRelease=function(releaseDate){$scope.marquees=marquees.filter(function(marquee){return marquee.release===releaseDate})},$scope.toggleMarquees=function(){$scope.marquees.forEach(function(marquee){return marquee.toggled=!marquee.toggled})}});