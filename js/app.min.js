...
var app=angular.module("app",["ui.bootstrap","ui.router","ngDialog","ngSanitize"]);app.config(function($stateProvider,$urlRouterProvider){$urlRouterProvider.otherwise("/"),$stateProvider.state("home",{url:"/",templateUrl:"../views/marquees/marquees.html",controller:function($scope){$scope.onrelease=!1}}).state("releases",{url:"/{release}",templateUrl:"../views/marquees/marquees.html",controller:function($scope,$stateParams){$scope.search.release=$stateParams}})}),app.factory("MarqueeData",function($http){return{getMarqueeData:function(callback){$http.get("js/services/marquees.json").success(callback)}}}),app.controller("MarqueesCtrl",function($scope,$stateParams,ngDialog,MarqueeData){$scope.isCollapsed=!0,$scope.disabled="disabled",$scope.search={m:"",release:""},MarqueeData.getMarqueeData(function(results){return $scope.m=results}),$scope.checkRelease=function(){return $scope.onrelease=$scope.search.m?!1:!0,$scope.onrelease},$scope.clickToOpen=function(){ngDialog.open({template:"../../views/newrelease.html",className:"ngdialog-theme-plain",scope:$scope})},$scope.showAllMarquees=function(){MarqueeData.getMarqueeData(function(results){return $scope.m.marquees=results.marquees})},$scope.removeMarquee=function(){},$scope.addMarquee=function(){},$scope.toggleMarquees=function(){$scope.m.marquees.forEach(function(marquee){return marquee.toggled=!marquee.toggled})},$scope.filterMarquees=function(releaseDate){$scope.search.m="",$scope.disabled="",MarqueeData.getMarqueeData(function(results){$scope.m.marquees=results.marquees.filter(function(marquee){return marquee.release===releaseDate})})},$scope.showMobile=function(marquee){marquee.showMobile=marquee.showMobile?!1:!0}}),app.directive("activerelease",function(){return{restrict:"E",templateUrl:"../../views/release/header.html",replace:!0}}),app.directive("marquees",function(){return{restrict:"E",templateUrl:"../../views/marquees/content.html"}}),app.directive("clickToEdit",function(){return{restrict:"A",replace:!1,templateUrl:"../../views/editor.html",controller:function($scope){$scope.data={editorEnabled:!1,secondLine:!1,firstLineCopy:"",secondLineCopy:""},$scope.enableEditor=function(){$scope.data.editorEnabled=!0},$scope.disableEditor=function(){$scope.data.editorEnabled=!1},$scope.save=function(){$scope.marquee.header=$scope.data.secondLineCopy?"<span>"+$scope.data.firstLineCopy+"</span><b>"+$scope.data.secondLineCopy+"</b>":"<span>"+$scope.data.firstLineCopy+"</span>",$scope.disableEditor()},$scope.toggle=function(){var spanPattern=/^<span/,boldPattern=/^<b/;$scope.data.secondLineCopy?$scope.marquee.header.match(spanPattern)?$scope.marquee.header="<b>"+$scope.data.firstLineCopy+"</b><span>"+$scope.data.secondLineCopy+"</span>":$scope.marquee.header.match(boldPattern)&&($scope.marquee.header="<span>"+$scope.data.firstLineCopy+"</span><b>"+$scope.data.secondLineCopy+"</b>"):console.log("No matches! Check logic in toggle function.")},$scope.newLine=function(){$scope.data.secondLine=!0},$scope.removeSecondLine=function(){$scope.marquee.header=$scope.data.firstLineCopy,$scope.data.secondLineCopy="",$scope.data.secondLine=!1}}}}),app.directive("timeline",function(){return{restrict:"E",templateUrl:"../../views/timeline.html"}}),app.directive("likecontrol",function(){return{restrict:"E",templateUrl:"../../views/likecontrol.html"}}),app.directive("phone",function(){return{restrict:"E",templateUrl:"../../views/marquees/phone.html"}}),app.directive("tablet",function(){return{restrict:"E",templateUrl:"../../views/marquees/tablet.html"}});